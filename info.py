...
API_ID = int(environ.get('API_ID', '19481274'))
API_HASH = environ.get('API_HASH', 'edbb4d162c4871c25ccd6f7179dad8cf')
BOT_TOKEN = environ.get('BOT_TOKEN', "8281405209:AAFEGlAxskOL0LBc7TgPk7TzwLl5Vi63rro")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '677605082 6585564185').split()] 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002761619105 -1002899768746').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002933718411'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003083281607'))  
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://variko4322_db_user:Neymarjr@cluster0.cdlal9p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'SilentXBotz_files')

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "False"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://yoket70070_db_user:Neymarjr@cluster0.jqgzosi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_CHANGE_LIMIT = int(environ.get('DB_CHANGE_LIMIT', "432")) 

GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviepubGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CFUpdates')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/parthip_jr')
